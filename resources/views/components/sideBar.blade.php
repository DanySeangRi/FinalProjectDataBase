...
@php
    ...
    $icons = [
        ...
        'logo' => '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M8 3 4 21l8-5 8 5-4-18-4 4-4-4z"/></svg>',
    ];
...
<aside class="w-64 h-full bg-white border-r border-slate-200 flex flex-col shrink-0">
    ...
    <div class="flex items-center gap-3 px-5 py-6 border-b border-slate-100">
        <div
            class="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-600 to-blue-500 flex items-center justify-center text-white">
            {!! $icons['logo'] !!}
        </div>
        <div class="leading-tight">
            <p class="text-sm font-bold text-slate-900">
                Travel <span class="text-orange-500">Admin</span>
            </p>
