            ...
            <form action="{{ route('bookTrip') }}" method="GET" class="
                ...
                <div class="
                    ...
                    <div class="flex-1">
                        ...
                        <input list="locations" name="from" value="{{ request('from') }}" placeholder="From" class="
                                w-full
                                text-sm
                                font-medium
                                outline-none
                ...
                <div class="
                    ...
                    <div class="flex-1">
                        ...
                        <input list="locations" name="to" value="{{ request('to') }}" placeholder="Going To" class="
                                w-full
                                text-sm
                                font-medium
                                outline-none
                ...
                <div class="
                    ...
                    <div class="flex-1">
                        ...
                        <input type="date" name="date" value="{{ request('date') }}" class="
                                w-full
                                text-sm
                                font-medium
                                outline-none
